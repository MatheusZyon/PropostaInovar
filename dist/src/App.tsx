  ...
  return (
    <div className="app bg-[#F4F1E8] text-[#272733]">
      ...
      <section id="about" className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="absolute inset-x-0 top-0 h-1/2 bg-[#F4F1E8] z-0"></div>
        
        <motion.div // CORRIGIDO: Esta motion.div agora envolve o conteúdo corretamente
        ...
        >
            {/* Logo CRIA RÁPIDO com dimensões responsivas */}
            <img 
              src={criaRapidoLogo} 
              alt="Logo CRIA RÁPIDO" 
              className="w-[200px] sm:w-[240px] md:w-[280px] lg:w-[320px] xl:w-[360px] mx-auto mb-4" // Reduzida margem inferior
            />
        ...
        </motion.div> {/* CORRIGIDO: Fechamento da motion.div */}
          
        <div className="bg-[#443F42] w-full py-6 mt-16"> {/* Adjusted margin-top for separation */}
          <div className="flex justify-center">
            <img
              src={setaBaixo}
              alt="Seta apontando"
              className="w-[200px] sm:w-[240px] md:w-[280px] lg:w-[320px] xl:w-[360px]"
            />
          </div>
        </div>
          
        <div className="container mx-auto px-4 mt-16"> {/* Added mt-16 for spacing */}
